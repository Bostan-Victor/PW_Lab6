...
export default function EditBetPage() {
  return (
    <main className="relative min-h-[80vh] flex items-center justify-center bg-gradient-to-tr from-blue-900 via-purple-800 to-pink-700 animate-gradient-x py-8 overflow-hidden">
